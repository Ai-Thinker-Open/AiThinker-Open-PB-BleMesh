...
API_RESULT vendor_aligenie_status_handler(UI_DATA_ALIGENIE_MODEL_T * private_data, MS_CALLBACK_DATA_T * ms_callback_data){return API_SUCCESS;}
API_RESULT vendor_aligenie_indication_handler(UI_DATA_ALIGENIE_MODEL_T * private_data, MS_CALLBACK_DATA_T * ms_callback_data){return API_SUCCESS;}
API_RESULT vendor_aligenie_transparent_msg_handler(UI_DATA_ALIGENIE_MODEL_T * private_data, MS_CALLBACK_DATA_T * ms_callback_data){return API_SUCCESS;}
API_RESULT vendor_aligenie_default_handler(UI_DATA_ALIGENIE_MODEL_T * private_data, MS_CALLBACK_DATA_T * ms_callback_data){return API_SUCCESS;}
...
//if(API_SUCCESS != init_attr_tbl(me))
//	{
