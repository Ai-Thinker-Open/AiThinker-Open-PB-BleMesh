...
UINT16 g_subscription_addr = 0xC102;
...
//  MS_ACCESS_ELEMENT_DESC   element;
    ...
    if (API_SUCCESS == retval)
    {
        ...
        retval = UI_generic_scene_model_server_create(element_handle1, FOGGER_MODE_NUM, fogger_mode_list);
    }
    ...
    if (API_SUCCESS == retval)
    {
        ...
        pinit_attr_tbl = init_attr_tbl_fogger;
