...
UINT16 g_subscription_addr = 0xC003;
extern DECL_CONST UINT16 curtain_mode_list[];
extern API_RESULT init_attr_tbl_curtain(UI_DATA_ALIGENIE_MODEL_T* me);
...
//  MS_ACCESS_ELEMENT_DESC   element;
    ...
    if (API_SUCCESS == retval)
    {
        ...
        retval = UI_generic_scene_model_server_create(element_handle1, LIGHT_MODE_NUM, curtain_mode_list);
    }
    ...
    if (API_SUCCESS == retval)
    {
        ...
        pinit_attr_tbl = init_attr_tbl_curtain;
