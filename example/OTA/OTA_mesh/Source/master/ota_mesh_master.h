...
#define OTAM_CONN_TIMEOUT_PERIOD                           500//100ms
...
#define OTAM_CONN_EVT                                   0x0100
#define OTAM_OTA_EVT                                    0x0200
...
extern bool otaMM_EstablishLink(uint8_t addr_type, uint8_t* addr);
extern void otaMM_Init( uint8 task_id );

extern uint16 otaMM_ProcessEvent( uint8 task_id, uint16 events );
