...
#define _MONTH(mm) (mm [2] == 'n' ? (mm [1] == 'a' ? 0 : 5)  : mm [2] == 'b' ? 1 : mm [2] == 'r' ? (mm [0] == 'M' ? 2 : 3) : mm [2] == 'y' ? 4 : mm [2] == 'n' ? 5 : mm [2] == 'l' ? 6 : mm [2] == 'g' ? 7 : mm [2] == 'p' ? 8 : mm [2] == 't' ? 9 : mm [2] == 'v' ? 10 : 11)  

#define _YEAR ((__DATE__ [9] - '0') * 10 + (__DATE__ [10] - '0'))  
#define __HOUR ((__TIME__ [0] - '0') * 10 + (__TIME__ [1] - '0'))
#define __MINUTE ((__TIME__ [3] - '0') * 10 + (__TIME__ [4] - '0'))
#define __SECOND ((__TIME__ [6] - '0') * 10 + (__TIME__ [7] - '0'))
...
//  DFL_ENTRY_BASE = 0x20008000;
	ret = dfl_init(0x11020000, 0x20008000, 0x8000);
